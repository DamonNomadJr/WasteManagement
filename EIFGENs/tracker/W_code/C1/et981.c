...
extern void F981_16325(EIF_REFERENCE, int);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 980, Current, 0, 0, 14734);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(980, Current, 14734);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
void F981_16325 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 980, Current, 0, 16324);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT(NULL, Current);
