...
extern EIF_TYPED_VALUE F986_8490(EIF_REFERENCE);
extern void F986_16370(EIF_REFERENCE, int);
...
/* {ETF_MODEL_ACCESS}.m */
RTOID (F986_8490)
EIF_TYPED_VALUE F986_8490 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 985, Current, 0, 0, 14806);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(985, Current, 14806);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80003D7, 0,0); /* Result */
	tr1 = RTLN(eif_new_type(983, 0x01).id);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(6311, Dtype(tr1)))(tr1);
	RTNHOOK(1,1);
...
void F986_16370 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 985, Current, 0, 16369);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT(NULL, Current);
