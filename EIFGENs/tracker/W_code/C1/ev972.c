...
extern EIF_TYPED_VALUE F972_8282(EIF_REFERENCE);
extern EIF_TYPED_VALUE F972_8283(EIF_REFERENCE);
extern EIF_TYPED_VALUE F972_8284(EIF_REFERENCE);
extern void F972_8285(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F972_8286(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F972_8287(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F972_8282 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F972_8283 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 971, Current, 1, 0, 14555);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(971, Current, 14555);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6122, Dtype(Current)))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	loc1 = RTCCL(tr1);
	if (EIF_TEST(loc1)) {
		RTHOOK(2);
...
EIF_TYPED_VALUE F972_8284 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(6118,Dtype(Current)));
	return r;
}


/* {EV_PND_TARGET_DATA}.set_name */
void F972_8285 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 971, Current, 0, 1, 14557);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(971, Current, 14557);
	RTCC(arg1, 971, l_feature_name, 1, eif_new_type(228, 0x01), 0x01);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 6122, 0xF80000ED, 0); /* internal_name */
...
void F972_8286 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 971, Current, 0, 1, 14558);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F972_8287 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 971, Current, 0, 1, 14559);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(971, Current, 14559);
	RTCC(arg1, 971, l_feature_name, 1, RTWCT(6116, dtype, Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
