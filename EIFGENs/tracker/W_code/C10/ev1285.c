...
extern EIF_TYPED_VALUE F1285_11555(EIF_REFERENCE);
extern void F1285_11556(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1285_11555 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1285_11556 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1284, Current, 0, 0, 18370);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1284, Current, 18370);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8406, 0xF8000591, 0); /* implementation */
