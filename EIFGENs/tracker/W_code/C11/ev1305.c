...
extern EIF_TYPED_VALUE F1305_11812(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1305_11812 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1304, Current, 0, 0, 18628);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1304, Current, 18628);
	RTIV(Current, RTAL);
	RTHOOK(1);
