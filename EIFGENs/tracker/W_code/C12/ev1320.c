...
extern void F1320_11948(EIF_REFERENCE);
...
void F1320_11948 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1319, Current, 0, 0, 18763);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1319, Current, 18763);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8357, 0xF80005D1, 0); /* implementation */
