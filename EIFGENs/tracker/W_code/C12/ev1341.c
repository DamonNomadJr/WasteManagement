...
extern EIF_TYPED_VALUE F1341_12153(EIF_REFERENCE);
extern void F1341_12154(EIF_REFERENCE);
extern void F1341_12155(EIF_REFERENCE);
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1340, Current, 0, 0, 18972);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	RTNHOOK(2,1);
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(9992, "parent", tr1))(tr1)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
...
EIF_TYPED_VALUE F1341_12153 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1341_12154 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1340, Current, 0, 0, 18974);
	RTSA(Dtype(Current));
	RTSC;
...
void F1341_12155 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1340, Current, 0, 0, 18975);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8406, 0xF800055F, 0); /* implementation */
