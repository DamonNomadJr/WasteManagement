...
extern void F1348_12241(EIF_REFERENCE);
extern void F1348_12242(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1348_12245(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1348_12246(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1348_12249(EIF_REFERENCE);
static EIF_TYPED_VALUE F1348_12250_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1348_12250(EIF_REFERENCE);
static EIF_TYPED_VALUE F1348_12251_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1348_12251(EIF_REFERENCE);
...
void F1348_12241 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 9395, 0x04000000, 1); /* is_locked */
	*(EIF_BOOLEAN *)(Current + RTWA(9395, Dtype(Current))) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
void F1348_12242 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 9395, 0x04000000, 1); /* is_locked */
	*(EIF_BOOLEAN *)(Current + RTWA(9395, Dtype(Current))) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
#define ur1 ur1x.it_r
	...
	if ((EIF_BOOLEAN)(tr1 == NULL)) {
		RTHOOK(2);
		RTDBGAA(Current, dtype, 9400, 0xF8000463, 0); /* pixel_iterator_internal */
		...
		ur1 = RTCCL(tr2);
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(7595, Dtype(tr1)))(tr1, ur1x);
		RTNHOOK(2,1);
		RTAR(Current, tr1);
...
EIF_TYPED_VALUE F1348_12249 (EIF_REFERENCE Current)
{
	GTCX
...
static EIF_TYPED_VALUE F1348_12250_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1348_12250 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9341, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1348_12250_body (Current)).it_r;
...
static EIF_TYPED_VALUE F1348_12251_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1348_12251 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9400, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1348_12251_body (Current)).it_r;
