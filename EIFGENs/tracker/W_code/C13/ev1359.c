...
extern void F1359_12527(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1359_12528(EIF_REFERENCE);
static EIF_TYPED_VALUE F1359_12529_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1359_12529(EIF_REFERENCE);
...
void F1359_12527 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
EIF_TYPED_VALUE F1359_12528 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F1359_12528,19235,RTMS32_EX_H("n\000\000\000o\000\000\000n\000\000\000a\000\000\000m\000\000\000e\000\000\000",6,2069000037));
}

/* {EV_COLOR_I}.interface */
static EIF_TYPED_VALUE F1359_12529_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1359_12529 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9341, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1359_12529_body (Current)).it_r;
