...
static EIF_TYPED_VALUE F1365_12620_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1365_12620(EIF_REFERENCE);
extern void F1365_16436(EIF_REFERENCE, int);
...
static EIF_TYPED_VALUE F1365_12620_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1364, Current, 0, 0, 19305);
	RTSA(Dtype(Current));
	RTSC;
...
EIF_TYPED_VALUE F1365_12620 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9341, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1365_12620_body (Current)).it_r;
...
void F1365_16436 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1364, Current, 0, 16435);
	RTSA(dtype);
	RTME(dtype, 0);
