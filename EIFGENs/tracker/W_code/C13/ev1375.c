...
static EIF_TYPED_VALUE F1375_13011_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1375_13011(EIF_REFERENCE);
extern void F1375_16441(EIF_REFERENCE, int);
...
static EIF_TYPED_VALUE F1375_13011_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1374, Current, 0, 0, 19664);
	RTSA(Dtype(Current));
	RTSC;
...
EIF_TYPED_VALUE F1375_13011 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9341, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1375_13011_body (Current)).it_r;
...
void F1375_16441 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1374, Current, 0, 16440);
	RTSA(dtype);
	RTME(dtype, 0);
