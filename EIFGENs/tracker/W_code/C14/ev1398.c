...
extern EIF_TYPED_VALUE F1398_13178(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1398_13178 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1397, Current, 0, 0, 19772);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1397, Current, 19772);
	RTIV(Current, RTAL);
	RTHOOK(1);
