...
extern EIF_TYPED_VALUE F1405_13245(EIF_REFERENCE);
extern void F1405_16444(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F1405_13245 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1405_16444 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1404, Current, 0, 16443);
	RTSA(dtype);
	RTME(dtype, 0);
