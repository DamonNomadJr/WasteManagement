...
extern EIF_TYPED_VALUE F1422_13524(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1422_13525(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1422_13526(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1422_13538(EIF_REFERENCE);
static EIF_TYPED_VALUE F1422_13539_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1422_13539(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1422_13524 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
EIF_TYPED_VALUE F1422_13525 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F1422_13538 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1421, Current, 6, 0, 20052);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1421, Current, 20052);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	loc2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10331, dtype))(Current)).it_i4);
	RTHOOK(4);
	tb1 = '\0';
	...
	if (tb1) {
		...
		if (tb1) {
			RTHOOK(6);
			RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
			Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10250, dtype))(Current)).it_i4);
			...
			if ((EIF_BOOLEAN) (loc2 < ti4_1)) {
				...
				loc4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10324, dtype))(Current)).it_i4);
				for (;;) {
					RTHOOK(11);
					...
					if ((EIF_BOOLEAN) ((EIF_BOOLEAN) (loc2 >= loc4) && (EIF_BOOLEAN) (loc2 <= loc3))) {
						...
						loc6 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10325, dtype))(Current)).it_i4);
...
/* {EV_BOX_I}.interface */
static EIF_TYPED_VALUE F1422_13539_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1421, Current, 0, 0, 20053);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1421, Current, 20053);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1422_13539 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9292, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1422_13539_body (Current)).it_r;
