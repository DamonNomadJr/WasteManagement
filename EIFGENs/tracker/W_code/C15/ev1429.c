...
extern void F1429_13604(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1429_13605(EIF_REFERENCE);
static EIF_TYPED_VALUE F1429_13606_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1429_13606(EIF_REFERENCE);
...
void F1429_13604 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1428, Current, 0, 1, 20118);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1428, Current, 20118);
	RTCC(arg1, 1428, l_feature_name, 1, RTWCT(9341, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1429_13605 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1428, Current, 0, 0, 20119);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
static EIF_TYPED_VALUE F1429_13606_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1429_13606 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9341, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1429_13606_body (Current)).it_r;
