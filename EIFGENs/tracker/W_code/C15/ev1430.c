...
extern void F1430_13607(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1430_13608(EIF_REFERENCE);
static EIF_TYPED_VALUE F1430_13609_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1430_13609(EIF_REFERENCE);
...
void F1430_13607 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1429, Current, 0, 1, 20122);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1429, Current, 20122);
	RTCC(arg1, 1429, l_feature_name, 1, RTWCT(9341, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1430_13608 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1429, Current, 0, 0, 20123);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1429, Current, 20123);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTHOOK(2);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9336, 1427))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
static EIF_TYPED_VALUE F1430_13609_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1429, Current, 0, 0, 20121);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1429, Current, 20121);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1430_13609 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9341, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1430_13609_body (Current)).it_r;
