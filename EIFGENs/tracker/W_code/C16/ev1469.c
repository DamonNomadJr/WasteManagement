...
extern void F1469_14255(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1469_14256(EIF_REFERENCE);
extern void F1469_14257(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1469_14258(EIF_REFERENCE);
extern void F1469_14259(EIF_REFERENCE);
extern void F1469_14260(EIF_REFERENCE);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1468, Current, 0, 1, 20596);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1468, Current, 20596);
	RTCC(arg1, 1468, l_feature_name, 1, RTWCT(9341, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
/* {EV_LABEL_IMP}.make */
void F1469_14255 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1468, Current, 2, 0, 20597);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTAOMS(14254,1);
	RTDBGEAA(1468, Current, 20597);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(4,1);
	RTCOMS(tr2,14254,0,"justify",7,1848530809);
	ur1 = tr2;
...
/* {EV_LABEL_IMP}.angle */
EIF_TYPED_VALUE F1469_14256 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REAL32;
	r.it_r4 = *(EIF_REAL_32 *)(Current + RTWA(10769,Dtype(Current)));
	return r;
}


/* {EV_LABEL_IMP}.set_angle */
void F1469_14257 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur4_1 ur4_1x.it_r4
	...
	RTEAA(l_feature_name, 1468, Current, 0, 1, 20599);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1468, Current, 20599);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tp1 = *(EIF_POINTER *)(Current + RTWA(10136, dtype));
	up1 = tp1;
	...
	RTHOOK(2);
	RTDBGAA(Current, dtype, 10769, 0x18000000, 1); /* angle */
	*(EIF_REAL_32 *)(Current + RTWA(10769, dtype)) = (EIF_REAL_32) arg1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTDBGLE;
...
void F1469_14258 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1468, Current, 0, 0, 20600);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1468, Current, 20600);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
void F1469_14259 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1468, Current, 0, 0, 20601);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1468, Current, 20601);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
void F1469_14260 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1468, Current, 0, 0, 20593);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1468, Current, 20593);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
static EIF_TYPED_VALUE F1469_14262_body (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1468, Current, 0, 0, 20595);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1468, Current, 20595);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
