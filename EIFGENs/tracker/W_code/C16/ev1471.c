...
extern void F1471_14264(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1471_14265(EIF_REFERENCE);
static EIF_TYPED_VALUE F1471_14266_body(EIF_REFERENCE);
...
void F1471_14264 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTCC(arg1, 1470, l_feature_name, 1, RTWCT(9341, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1471_14265 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1470, Current, 1, 0, 20604);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTHOOK(6);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9336, 1469))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(7);
...
static EIF_TYPED_VALUE F1471_14266_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1470, Current, 0, 0, 20605);
	RTSA(Dtype(Current));
	RTSC;
...
EIF_TYPED_VALUE F1471_14266 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9341, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1471_14266_body (Current)).it_r;
