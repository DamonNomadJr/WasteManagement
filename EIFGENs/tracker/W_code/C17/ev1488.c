...
static EIF_TYPED_VALUE F1488_14662_body(EIF_REFERENCE);
...
static EIF_TYPED_VALUE F1488_14662_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1487, Current, 0, 0, 20991);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1487, Current, 20991);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1488_14662 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9341, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1488_14662_body (Current)).it_r;
