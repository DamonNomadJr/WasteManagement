...
extern EIF_TYPED_VALUE F1008_8604(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1008_8605(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1008_8606(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1008_8607(EIF_REFERENCE);
...
{
	GTCX
	RTOTC (F1008_8600,14890,RTMS_EX_H("English",7,257590376));
}
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1007, Current, 0, 0, 14890);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1007, Current, 14890);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1007, Current, 0, 0, 14891);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1007, Current, 14891);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000F7, 0,0); /* Result */
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1007, Current, 0, 0, 14892);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1007, Current, 14892);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000F7, 0,0); /* Result */
...
RTOID (F1008_8604)
EIF_TYPED_VALUE F1008_8604 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1007, Current, 0, 0, 14893);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1007, Current, 14893);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000F7, 0,0); /* Result */
...
EIF_TYPED_VALUE F1008_8605 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F1008_8605,14895,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
EIF_TYPED_VALUE F1008_8606 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F1008_8606,14896,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
EIF_TYPED_VALUE F1008_8607 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F1008_8607,14897,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}
...
void EIF_Minit1008 (void)
{
	...
	RTOTS (8604,F1008_8604)
	RTOTS (8605,F1008_8605)
	RTOTS (8606,F1008_8606)
	RTOTS (8607,F1008_8607)
}
