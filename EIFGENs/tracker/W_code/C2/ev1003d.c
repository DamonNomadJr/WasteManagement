...
static const EIF_TYPE_INDEX egt_13_1003 [] = {0xFF01,246,0xFF01,237,0xFFFF};
static const EIF_TYPE_INDEX egt_14_1003 [] = {0xFF01,246,0xFF01,237,0xFFFF};
static const EIF_TYPE_INDEX egt_15_1003 [] = {0xFF01,246,0xFF01,237,0xFFFF};
...
static const struct desc_info desc_1003[] = {
	...
	{EIF_GENERIC(egt_13_1003), 14880, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_1003), 14881, 0xFFFFFFFF},
	{EIF_GENERIC(egt_15_1003), 14882, 0xFFFFFFFF},
};
void Init1003(void)
{
	IDSC(desc_1003, 0, 1002);
	IDSC(desc_1003 + 1, 1, 1002);
	IDSC(desc_1003 + 32, 802, 1002);
}
