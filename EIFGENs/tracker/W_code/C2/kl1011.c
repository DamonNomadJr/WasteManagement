...
extern EIF_TYPED_VALUE F1011_8662(EIF_REFERENCE);
...
RTOID (F1011_8662)
EIF_TYPED_VALUE F1011_8662 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1010, Current, 0, 0, 14959);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1010, Current, 14959);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
