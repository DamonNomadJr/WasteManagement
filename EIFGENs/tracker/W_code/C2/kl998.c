...
extern EIF_TYPED_VALUE F998_8544(EIF_REFERENCE);
extern EIF_TYPED_VALUE F998_8545(EIF_REFERENCE);
...
RTOID (F998_8544)
EIF_TYPED_VALUE F998_8544 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 997, Current, 0, 0, 14857);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(997, Current, 14857);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F998_8545)
EIF_TYPED_VALUE F998_8545 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 997, Current, 0, 0, 14858);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(997, Current, 14858);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
{
	GTCX
	RTOTS (8544,F998_8544)
	RTOTS (8545,F998_8545)
}
