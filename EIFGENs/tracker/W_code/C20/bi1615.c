...
extern EIF_TYPED_VALUE F1615_1904(EIF_REFERENCE);
extern void F1615_1905(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1615_1906(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1615_1907(EIF_REFERENCE);
extern void F1615_1908(EIF_REFERENCE);
extern void F1615_1909(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1615_1910(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1615_1911(EIF_REFERENCE);
extern void F1615_1912(EIF_REFERENCE);
extern void F1615_7005(EIF_REFERENCE, int);
...
/* {BI_LINKABLE}.left */
EIF_TYPED_VALUE F1615_1904 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1615_1905 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1614, Current, 2, 1, 16071);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1614, Current, 16071);
	RTCC(arg1, 1614, l_feature_name, 1, eif_new_type(Dftype(Current), 0), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTHOOK(4);
	RTDBGAA(Current, dtype, 1688, 0xF800064E, 0); /* right */
	RTAR(Current, arg1);
...
void F1615_1906 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1614, Current, 1, 1, 16072);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1614, Current, 16072);
	RTCC(arg1, 1614, l_feature_name, 1, eif_new_type(Dftype(Current), 0), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 1, 0xF800064E, 0, 0); /* loc1 */
	...
	RTHOOK(4);
	RTDBGAA(Current, dtype, 1691, 0xF800064E, 0); /* left */
	RTAR(Current, arg1);
...
void F1615_1907 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1614, Current, 2, 0, 16073);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1614, Current, 16073);
	RTIV(Current, RTAL);
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		RTE_OT
...
void F1615_1908 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1614, Current, 2, 0, 16074);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1614, Current, 16074);
	RTIV(Current, RTAL);
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		RTE_OT
...
void F1615_1909 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1614, Current, 1, 1, 16075);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1614, Current, 16075);
	RTCC(arg1, 1614, l_feature_name, 1, eif_new_type(Dftype(Current), 0), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 1, 0xF800064E, 0, 0); /* loc1 */
...
void F1615_1910 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1614, Current, 1, 1, 16076);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1614, Current, 16076);
	RTCC(arg1, 1614, l_feature_name, 1, eif_new_type(Dftype(Current), 0), 0x00);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 1, 0xF800064E, 0, 0); /* loc1 */
...
void F1615_1911 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1614, Current, 0, 0, 16077);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1614, Current, 16077);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 1688, 0xF800064E, 0); /* right */
...
void F1615_1912 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1614, Current, 0, 0, 16078);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1614, Current, 16078);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 1691, 0xF800064E, 0); /* left */
	*(EIF_REFERENCE *)(Current + RTWA(1691, dtype)) = (EIF_REFERENCE) NULL;
...
void F1615_7005 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU(SK_REF, &loc1);
	RTLU(SK_REF, &loc2);
	RTEAINV(l_feature_name, 1614, Current, 2, 7004);
	RTSA(dtype);
	RTME(dtype, 0);
