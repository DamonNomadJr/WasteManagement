...
static EIF_TYPED_VALUE F1055_9079_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1055_9079(EIF_REFERENCE);
extern void F1055_9080(EIF_REFERENCE, EIF_TYPED_VALUE);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1054, Current, 1, 0, 15331);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (EIF_TEST(loc1)) {
		...
		RTHOOK(4);
		ur1 = RTCCL(Result);
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(6893, dtype))(Current, ur1x);
		RTHOOK(5);
		RTDBGAA(Current, dtype, 6892, 0xF800047D, 0); /* expose_actions_internal */
		RTAR(Current, Result);
...
static EIF_TYPED_VALUE F1055_9079_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1054, Current, 0, 0, 15332);
	RTSA(Dtype(Current));
	RTSC;
...
EIF_TYPED_VALUE F1055_9079 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(6892, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1055_9079_body (Current)).it_r;
...
void F1055_9080 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTCC(arg1, 1054, l_feature_name, 1, RTWCT(6891, Dtype(Current), Dftype(Current)), 0x00);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
