...
static const EIF_TYPE_INDEX egt_13_1079 [] = {0xFF01,247,0xFF01,974,0xFFFF};
...
static const struct desc_info desc_1079[] = {
	...
	{EIF_GENERIC(egt_9_1079), 15517, 0xFFFFFFFF},
	...
	{EIF_GENERIC(egt_13_1079), 15514, 0},
	{EIF_GENERIC(egt_14_1079), 15515, 0xFFFFFFFF},
	{EIF_GENERIC(egt_15_1079), 15516, 0xFFFFFFFF},
};
void Init1079(void)
{
	IDSC(desc_1079, 0, 1078);
	IDSC(desc_1079 + 1, 1, 1078);
	IDSC(desc_1079 + 32, 421, 1078);
	IDSC(desc_1079 + 34, 425, 1078);
}
