...
static const EIF_TYPE_INDEX egt_15_1100 [] = {0xFF01,978,0xFFFF};
...
static const struct desc_info desc_1100[] = {
	...
	{EIF_GENERIC(egt_13_1100), 15586, 0},
	{EIF_GENERIC(egt_14_1100), 15587, 8},
	...
	{EIF_GENERIC(egt_15_1100), 15597, 16},
	{EIF_GENERIC(egt_16_1100), 15598, 0xFFFFFFFF},
};
void Init1100(void)
{
	IDSC(desc_1100, 0, 1099);
	IDSC(desc_1100 + 1, 1, 1099);
	IDSC(desc_1100 + 32, 375, 1099);
	IDSC(desc_1100 + 39, 362, 1099);
}
