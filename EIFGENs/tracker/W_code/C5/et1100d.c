...
static const struct desc_info desc_1100[] = {
	...
	{EIF_GENERIC(egt_9_1100), 15649, 0xFFFFFFFF},
	...
	{EIF_GENERIC(egt_13_1100), 15621, 0},
	{EIF_GENERIC(NULL), 15622, 0xFFFFFFFF},
	{EIF_GENERIC(NULL), 15647, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x018F /*199*/), 15648, 8},
};
void Init1100(void)
{
	IDSC(desc_1100, 0, 1099);
	IDSC(desc_1100 + 1, 1, 1099);
	IDSC(desc_1100 + 32, 395, 1099);
	IDSC(desc_1100 + 34, 392, 1099);
}
