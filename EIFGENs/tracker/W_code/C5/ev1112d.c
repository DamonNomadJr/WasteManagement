...
static const EIF_TYPE_INDEX egt_13_1112 [] = {0xFF01,1256,0xFFFF};
static const EIF_TYPE_INDEX egt_14_1112 [] = {0xFF05,1256,0xFFFF};
...
static const struct desc_info desc_1112[] = {
	...
	{EIF_GENERIC(egt_13_1112), 15715, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_1112), 15712, 0xFFFFFFFF},
	{EIF_GENERIC(NULL), 15713, 0xFFFFFFFF},
	{EIF_GENERIC(egt_15_1112), 15714, 0xFFFFFFFF},
};
void Init1112(void)
{
	IDSC(desc_1112, 0, 1111);
	IDSC(desc_1112 + 1, 1, 1111);
	IDSC(desc_1112 + 32, 509, 1111);
}
