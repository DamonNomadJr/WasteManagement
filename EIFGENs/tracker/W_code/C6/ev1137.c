...
extern void F1137_10097(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1137_10098(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1137_10099(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1137_10100(EIF_REFERENCE);
extern void F1137_10101(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1137_10102(EIF_REFERENCE, EIF_TYPED_VALUE);
...
void F1137_10097 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1136, Current, 2, 1, 16801);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1136, Current, 16801);
	if (arg1) {
		{
	...
	if ((EIF_BOOLEAN)(arg1 != NULL)) {
		...
		switch (ti4_1) {
			case 1L:
				...
				ur1 = RTCCL(tr3);
				tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(7761, dtype))(Current, ur1x)).it_b);
				if (tb1) {
					RTHOOK(4);
					...
					for (;;) {
						...
						if (tb2) {
							...
							RTCC(tr4, 1136, l_feature_name, 1, eif_gen_param(Dftype(loc2), 1),0);
...
void F1137_10098 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1136, Current, 0, 1, 16802);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1136, Current, 16802);
	if (arg1) {
		{
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, Dtype(Current), 7759, 0xF8000106, 0); /* veto_pebble_function */
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(7759, Dtype(Current))) = (EIF_REFERENCE) RTCCL(arg1);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
EIF_TYPED_VALUE F1137_10099 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1136, Current, 2, 1, 16803);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1136, Current, 16803);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1137_10100 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1137_10101 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define arg2 arg2x.it_r
	...
	RTEAA(l_feature_name, 1136, Current, 0, 2, 16805);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1136, Current, 16805);
	{
	...
	RTCC(arg2, 1136, l_feature_name, 2, eif_new_type(228, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1137_10102 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1136, Current, 2, 1, 16806);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1136, Current, 16806);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7759, Dtype(Current)))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	loc2 = RTCCL(tr1);
	if (EIF_TEST(loc2)) {
		RTHOOK(2);
		...
		if (tb1) {
			...
			RTCC(tr1, 1136, l_feature_name, 1, eif_gen_param(Dftype(loc1), 1),0);
