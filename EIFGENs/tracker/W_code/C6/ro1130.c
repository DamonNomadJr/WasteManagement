...
extern void F1130_9996(EIF_REFERENCE);
extern void F1130_9997(EIF_REFERENCE);
extern void F1130_16381(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F1130_9995 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1129, Current, 0, 0, 16371);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1129, Current, 16371);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7686, Dtype(Current)))(Current)).it_i4);
...
/* {ROOT}.add_tests */
void F1130_9996 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1129, Current, 0, 0, 16372);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1129, Current, 16372);
	RTIV(Current, RTAL);
...
void F1130_9997 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1129, Current, 2, 0, 16373);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1129, Current, 16373);
	RTIV(Current, RTAL);
	RTE_T
	RTHOOK(1);
	...
	if (loc1) {
		...
		switch (ti4_1) {
			...
			case 5L:
				RTHOOK(16);
				(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(7646, dtype))(Current);
				break;
			default:
				if (RTAL & CK_CHECK) {
					RTHOOK(17);
...
/* {ROOT}._invariant */
void F1130_16381 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1129, Current, 0, 16380);
	RTSA(dtype);
	RTME(dtype, 0);
