...
extern EIF_TYPED_VALUE F1125_9912(EIF_REFERENCE);
...
RTOID (F1125_9912)
EIF_TYPED_VALUE F1125_9912 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1124, Current, 0, 0, 16288);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
