...
extern void F1171_10310(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1171_10311(EIF_REFERENCE);
extern void EIF_Minit1171(void);
extern EIF_REFERENCE _A1171_56();
...
/* {ETF_DUMMY}.make */
void F1171_10310 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ur3 ur3x.it_r
	...
	RTEAA(l_feature_name, 1170, Current, 0, 3, 17009);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr2 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A1171_56, (EIF_POINTER)(0),7911, 0, 0, 1, -1, tr1, 0);
	}
	RTAR(Current, tr2);
	*(EIF_REFERENCE *)(Current + RTWA(7901, dtype)) = (EIF_REFERENCE) RTCCL(tr2);
	RTHOOK(3);
...
/* {ETF_DUMMY}.etf_dummy */
void F1171_10311 (EIF_REFERENCE Current)
{
	GTCX
