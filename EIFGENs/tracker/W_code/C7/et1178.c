...
extern void F1178_10284(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
void F1178_10284 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ur3 ur3x.it_r
	...
	RTEAA(l_feature_name, 1177, Current, 0, 3, 16978);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1177, Current, 16978);
	RTCC(arg1, 1177, l_feature_name, 1, eif_new_type(231, 0x01), 0x01);
	RTCC(arg2, 1177, l_feature_name, 2, eif_new_type(231, 0x01), 0x01);
	RTCC(arg3, 1177, l_feature_name, 3, eif_new_type(231, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		ur2 = RTCCL(arg2);
		ur3 = RTCCL(arg3);
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(7869, dtype))(Current, ur1x, ur2x, ur3x)).it_b);
		RTTE(tb1, label_1);
		RTCK;
		RTJB;
label_1:
