/*
 * Code for class ETF_NEW_CONTAINER
 */
...
extern void F1185_10337(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
/* {ETF_NEW_CONTAINER}.new_container */
void F1185_10337 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ur3 ur3x.it_r
	...
	RTEAA(l_feature_name, 1184, Current, 0, 3, 17029);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTCC(arg3, 1184, l_feature_name, 3, eif_new_type(231, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		ur2 = RTCCL(arg2);
		ur3 = RTCCL(arg3);
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(7922, dtype))(Current, ur1x, ur2x, ur3x)).it_b);
		RTTE(tb1, label_1);
		RTCK;
		RTJB;
label_1:
...
body:;
	...
	ur2 = RTCCL(arg2);
	ur3 = RTCCL(arg3);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(6315, "create_container", tr1))(tr1, ur1x, ur2x, ur3x);
	RTHOOK(4);
