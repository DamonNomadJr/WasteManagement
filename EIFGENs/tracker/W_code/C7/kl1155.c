...
extern EIF_TYPED_VALUE F1155_10153(EIF_REFERENCE);
...
RTOID (F1155_10153)
EIF_TYPED_VALUE F1155_10153 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1154, Current, 0, 0, 16856);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1154, Current, 16856);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
