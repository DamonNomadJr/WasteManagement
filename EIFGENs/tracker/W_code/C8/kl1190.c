...
extern EIF_TYPED_VALUE F1190_10391(EIF_REFERENCE);
...
RTOID (F1190_10391)
EIF_TYPED_VALUE F1190_10391 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1189, Current, 0, 0, 17134);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1189, Current, 17134);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
