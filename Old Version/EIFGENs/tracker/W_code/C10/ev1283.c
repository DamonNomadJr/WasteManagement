...
extern EIF_TYPED_VALUE F1283_11512(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1283_11512 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
#define up1 up1x.it_p
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8357, 0xF800058F, 0); /* implementation */
