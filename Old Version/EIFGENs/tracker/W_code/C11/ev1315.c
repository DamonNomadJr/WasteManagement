...
extern void F1315_11922(EIF_REFERENCE);
...
void F1315_11922 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1314, Current, 0, 0, 18737);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1314, Current, 18737);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8357, 0xF80005C8, 0); /* implementation */
