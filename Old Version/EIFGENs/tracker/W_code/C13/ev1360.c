...
extern EIF_TYPED_VALUE F1360_12548(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1360_12549(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1360_12550(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1360_12557(EIF_REFERENCE);
static EIF_TYPED_VALUE F1360_12558_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1360_12558(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1360_12559(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1360_12560(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1360_12561(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1360_12562(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1360_12563(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1360_12548 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1359, Current, 1, 0, 19249);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	ur1 = RTCCL(tr1);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(9589, dtype))(Current, ur1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	loc1 = RTCCL(tr1);
	loc1 = RTRV(eif_new_type(1362, 0x01),loc1);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1359, Current, 1, 0, 19250);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (EIF_TEST(loc1)) {
		...
		RTDBGAL(Current, 0, 0xF80004E5, 0,0); /* Result */
		ur1 = RTCCL(loc1);
		Result = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(9588, dtype))(Current, ur1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1359, Current, 1, 0, 19251);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	if (tb1) {
		...
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(9587, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		ur1 = RTCCL(tr1);
		Result = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(9590, dtype))(Current, ur1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(5);
...
EIF_TYPED_VALUE F1360_12557 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1359, Current, 2, 0, 19242);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (!((EIF_BOOLEAN) !EIF_TEST(loc1))) {
		loc2 = RTCCL(loc1);
		loc2 = RTRV(eif_new_type(1362, 0x01),loc2);
...
static EIF_TYPED_VALUE F1360_12558_body (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1359, Current, 0, 0, 19243);
	RTSA(Dtype(Current));
	RTSC;
...
RTOID (F1360_12559)
EIF_TYPED_VALUE F1360_12559 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOQRR
	...
	RTEAA(l_feature_name, 1359, Current, 0, 0, 19244);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	{
		static EIF_TYPE_INDEX typarr0[] = {0xFF05,464,0xFF04,1362,0xFFFF};
		EIF_TYPE typres0;
...
EIF_TYPED_VALUE F1360_12560 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTCC(arg1, 1359, l_feature_name, 1, eif_new_type(1362, 0x05), 0x05);
...
EIF_TYPED_VALUE F1360_12561 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1359, Current, 0, 1, 19246);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1359, Current, 19246);
	RTCC(arg1, 1359, l_feature_name, 1, RTWCT(9587, Dtype(Current), Dftype(Current)), 0x00);
	uarg1 = (EIF_BOOLEAN) RTS_OU (arg1);
	uarg = uarg1;
	if (uarg) {
		RTS_RC;
...
EIF_TYPED_VALUE F1360_12562 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1359, Current, 4, 1, 19247);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1359, Current, 19247);
	RTCC(arg1, 1359, l_feature_name, 1, RTWCT(9587, dtype, Dftype(Current)), 0x00);
	uarg1 = (EIF_BOOLEAN) RTS_OU (arg1);
	uarg = uarg1;
	if (uarg) {
		RTS_RC;
...
body:;
	...
	if ((EIF_BOOLEAN) !EIF_TEST(loc3)) {
		...
		RTHOOK(5);
		loc4 = RTCCL(loc3);
		loc4 = RTRV(eif_new_type(1362, 0x01),loc4);
		if ((loc4) && RTS_OS (Current, loc4)) loc4 = (EIF_REFERENCE) 0;
		if (EIF_TEST(loc4)) {
			RTHOOK(6);
			tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(9290, "is_destroyed", loc4))(loc4)).it_b);
			if (tb1) {
				RTHOOK(7);
				RTDBGAL(Current, 0, 0xF8000552, 0,0); /* Result */
				tr1 = RTLN(eif_new_type(1363, 0x01).id);
...
void F1360_12563 (EIF_REFERENCE Current)
{
	GTCX
