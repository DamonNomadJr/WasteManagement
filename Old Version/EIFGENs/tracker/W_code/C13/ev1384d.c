...
static const EIF_TYPE_INDEX egt_14_1384 [] = {0xFF01,1139,0xFFFF};
static const EIF_TYPE_INDEX egt_15_1384 [] = {262,0xFF01,0xFFF9,1,185,0xFF01,1256,202,0xFFFF};
...
static const struct desc_info desc_1384[] = {
	...
	{EIF_GENERIC(egt_13_1384), 18942, 0xFFFFFFFF},
	...
	{EIF_GENERIC(egt_14_1384), 14897, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x08E7 /*1139*/), 14898, 0},
	{EIF_GENERIC(egt_15_1384), 19713, 16},
...
void Init1384(void)
{
	...
	IDSC(desc_1384 + 32, 524, 1383);
	IDSC(desc_1384 + 59, 778, 1383);
	IDSC(desc_1384 + 61, 666, 1383);
}
