...
extern void F1407_13243(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1407_13244(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1407_13245(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1407_13246(EIF_REFERENCE);
extern void F1407_13247(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1407_13248_body(EIF_REFERENCE);
...
void F1407_13243 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1406, Current, 0, 1, 19815);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1406, Current, 19815);
	RTCC(arg1, 1406, l_feature_name, 1, RTWCT(9292, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1407_13244 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1406, Current, 3, 0, 19816);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1406, Current, 19816);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr3 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A1208_334, (EIF_POINTER)(0),8145, 0, 0, 1, -1, tr2, 0);
	}
	ur2 = RTCCL(tr3);
	ur3 = NULL;
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr3 = RTLNRW(typres0.id, 0, (EIF_POINTER) _A1208_335, (EIF_POINTER)(0),8146, 0, 0, 1, -1, tr2, 0);
	}
	ur2 = RTCCL(tr3);
	ur3 = NULL;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(9814, dtype))(Current, up1x, ur1x, ur2x, ur3x);
	...
	ur1 = RTCCL(tr2);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(10117, dtype))(Current, ur1x);
	RTHOOK(12);
	ub1 = (EIF_BOOLEAN) 1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(9305, dtype))(Current, ub1x);
	if (RTAL & CK_ENSURE) {
...
EIF_TYPED_VALUE F1407_13245 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1406, Current, 2, 0, 19817);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1406, Current, 19817);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = '\0';
...
EIF_TYPED_VALUE F1407_13246 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = *(EIF_REFERENCE *)(Current + RTWA(10131,Dtype(Current)));
	return r;
}
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1406, Current, 1, 1, 19819);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1406, Current, 19819);
	RTCC(arg1, 1406, l_feature_name, 1, eif_new_type(184, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 10131, 0xF80000B8, 0); /* start_path */
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(10131, dtype)) = (EIF_REFERENCE) RTCCL(arg1);
	RTHOOK(3);
...
static EIF_TYPED_VALUE F1407_13248_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1406, Current, 0, 0, 19820);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1406, Current, 19820);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1407_13248 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9292, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1407_13248_body (Current)).it_r;
