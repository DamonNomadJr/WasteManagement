...
extern void F1448_13919(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1448_13920_body(EIF_REFERENCE);
...
void F1448_13919 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1447, Current, 1, 1, 20339);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1447, Current, 20339);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	for (;;) {
		...
		RTNHOOK(4,2);
		ub1 = arg1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(10812, "update_for_pick_and_drop", tr2))(tr2, ub1x);
		RTHOOK(5);
...
static EIF_TYPED_VALUE F1448_13920_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1447, Current, 0, 0, 20340);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1447, Current, 20340);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1448_13920 (EIF_REFERENCE Current)
{
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9292, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1448_13920_body (Current)).it_r;
