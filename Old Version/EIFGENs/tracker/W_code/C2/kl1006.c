...
extern EIF_TYPED_VALUE F1006_8591(EIF_REFERENCE);
...
RTOID (F1006_8591)
EIF_TYPED_VALUE F1006_8591 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1005, Current, 0, 0, 14888);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
