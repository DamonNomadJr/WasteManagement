...
extern EIF_TYPED_VALUE F993_8473(EIF_REFERENCE);
extern EIF_TYPED_VALUE F993_8474(EIF_REFERENCE);
...
RTOID (F993_8473)
EIF_TYPED_VALUE F993_8473 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 992, Current, 0, 0, 14786);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(992, Current, 14786);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F993_8474)
EIF_TYPED_VALUE F993_8474 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 992, Current, 0, 0, 14787);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(992, Current, 14787);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
{
	GTCX
	RTOTS (8473,F993_8473)
	RTOTS (8474,F993_8474)
}
