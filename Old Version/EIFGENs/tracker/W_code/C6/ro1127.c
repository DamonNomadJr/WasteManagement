...
extern void F1127_9951(EIF_REFERENCE);
extern void F1127_9952(EIF_REFERENCE);
extern void F1127_16336(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F1127_9950 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1126, Current, 0, 0, 16329);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(1126, Current, 16329);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7637, Dtype(Current)))(Current)).it_i4);
...
/* {ROOT}.add_tests */
void F1127_9951 (EIF_REFERENCE Current)
{
	GTCX
...
void F1127_9952 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1126, Current, 2, 0, 16322);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (loc1) {
		...
		if (!(EIF_BOOLEAN)(ti4_1 == ti4_2)) {
			ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7639, dtype))(Current)).it_i4);
			ti4_2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7637, dtype))(Current)).it_i4);
		...
		switch (ti4_1) {
			case 1L:
				...
				if ((EIF_BOOLEAN)(ti4_1 == ((EIF_INTEGER_32) 0L))) {
					...
					RTHOOK(10);
					(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(6744, dtype))(Current);
					RTHOOK(11);
			...
			case 5L:
				RTHOOK(16);
				(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(7597, dtype))(Current);
				break;
			default:
				if (RTAL & CK_CHECK) {
					RTHOOK(17);
...
/* {ROOT}._invariant */
void F1127_16336 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1126, Current, 0, 16335);
	RTSA(dtype);
	RTME(dtype, 0);
