...
extern void F1174_10277(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
void F1174_10277 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ur3 ur3x.it_r
	...
	RTEAA(l_feature_name, 1173, Current, 0, 3, 16973);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1173, Current, 16973);
	...
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		ur2 = RTCCL(arg2);
		ur3 = RTCCL(arg3);
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(7866, dtype))(Current, ur1x, ur2x, ur3x)).it_b);
		RTTE(tb1, label_1);
		RTCK;
		RTJB;
label_1:
